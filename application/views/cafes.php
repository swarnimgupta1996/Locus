                 ...
                 <?php  $c=0;
                  ...
                  <div class="col-sm-4"> 
                   <div class="card" style="width:34rem;background-color:white;padding:30px;margin-top:20px;" >
                       ...
                       <a href=""><img class="card-img-top" src="<?=base_url($cafe[$counter]['thumbnail'])?>" style="width:100%;height:180px;"> </a>
                         <div class="card-block">
                           <h4 class="card-title"><a style="text-decoration: none;" href=""><?= $cafe[$counter++]['name'] ?></a></h4>
                            <p class="card-text">Contact No. <?= $cafe[$counter-1]['phone'] ?></p>
