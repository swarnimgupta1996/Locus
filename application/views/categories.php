...
<body style="background-color:rgb(246, 240, 240);">
  ...
  <div class="navigation-bar">
    ...
    <div class="row top2">
     <div class="col-sm-2">
      <a href="<?=base_url()?>index.php/locus"> <img  class="logo" src="<?=base_url("assets/images/logo_1.png")?>" alt="logo" width="140px" height="48px" style="margin-left:50px" ></img> </a>
     </div>
             ...
             <h2>Cafes</h2>
               ...
               <div class="row">
                 <?php  $cnt=0;
                  while($cnt!=3 && $len!=0){ ?>
                  <div class="col-sm-4"> 
                   <div class="card" style="width:34rem;background-color:white;padding:30px;margin-top:20px;" >

                       <a href="<?=base_url()?>index.php/locus/index_food_place/<?= $c[$counter]['name'] ?>"><img class="card-img-top" src="<?=base_url($c[$counter]['thumbnail'])?>" style="width:100%;height:180px;"> </a>
                         <div class="card-block">
                           <h4 class="card-title"><a style="text-decoration: none;" href=""><?= $c[$counter]['name'] ?></a></h4>
                            <p class="card-text">Contact No. <?= $c[$counter]['phone'] ?></p>
                            <a href="#" class="btn btn-primary">View Menu</a>
                             <a href="<?=base_url()?>index.php/locus/index_food_place/c" class="btn btn-primary">View Details</a>
                           </div>
                  </div>                 
                   </div>
                  <?php $len--;
                 ...
                 <?php  $cnt=0;
                  ...
                  <div class="col-sm-4"> 
                   <div class="card" style="width:34rem;background-color:white;padding:30px;margin-top:20px;" >
                       ...
                       <a href=""><img class="card-img-top" src="<?=base_url($r[$counter]['thumbnail'])?>" style="width:100%;height:180px;"> </a>
                         <div class="card-block">
                           <h4 class="card-title"><a style="text-decoration: none;" href=""><?= $r[$counter]['name'] ?></a></h4>
                            <p class="card-text">Contact No. <?= $r[$counter]['phone'] ?></p>
                            <a href="#" class="btn btn-primary">View Menu</a>
                 ...
                 <?php  $cnt=0;
                  ...
                  <div class="col-sm-4"> 
                   <div class="card" style="width:34rem;background-color:white;padding:30px;margin-top:20px;" >
                       ...
                       <a href=""><img class="card-img-top" src="<?=base_url($b[$counter]['thumbnail'])?>" style="width:100%;height:180px;"> </a>
                         <div class="card-block">
                           <h4 class="card-title"><a style="text-decoration: none;" href=""><?= $b[$counter]['name'] ?></a></h4>
                            <p class="card-text">Contact No. <?= $b[$counter]['phone'] ?></p>
                            <a href="#" class="btn btn-primary">View Menu</a>
                             <a href="#" class="btn btn-primary">View Details</a>
                           </div>
                  </div>                 
                 ...
                 <?php  $cnt=0;
                  ...
                  <div class="col-sm-4"> 
                   <div class="card" style="width:34rem;background-color:white;padding:30px;margin-top:20px;" >
                       ...
                       <a href=""><img class="card-img-top" src="<?=base_url($d[$counter]['thumbnail'])?>" style="width:100%;height:180px;"> </a>
                         <div class="card-block">
                           <h4 class="card-title"><a style="text-decoration: none;" href=""><?= $d[$counter]['name'] ?></a></h4>
                            <p class="card-text">Contact No. <?= $d[$counter]['phone'] ?></p>
                            <a href="#" class="btn btn-primary">View Menu</a>
                             <a href="#" class="btn btn-primary">View Details</a>
                           </div>
                  </div>                 
