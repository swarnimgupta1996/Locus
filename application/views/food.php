...
<div class="container">
    ...
    <div class="col-md-12">
         <h2><a href="<?=base_url()?>index.php/locus/index_food_category/c" style="text-decoration:none;font-weight: 60px;">Cafes</a></h2>
         <div class="well">
          <div id="myCarousel" class="carousel slide">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active">
                    ...
                    $t =  $cafe[$counter++]['thumbnail'];?>
                    <div class="col-sm-3"><a href="#x"><img src="<?=base_url($t)?>" alt="Image" class="img-responsive"></a>
                    <caption><?=$cafe[$counter-1]['name'] ?></caption>
                    </div>
                    <?php   }  ?>
                  </div>
                  <!--/row-->
 ...
 <div class="col-md-12">
         <h2><a href="<?=base_url()?>index.php/locus/index_food_category/r" style="text-decoration:none;font-weight: 60px;">Restaurants</a></h2>
         <div class="well">
          <div id="myCarousel2" class="carousel slide">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active">
                    ...
                    $t =  $restaurant[$counter++]['thumbnail'];?>
                    <div class="col-sm-3"><a href="#x"><img src="<?=base_url($t)?>" alt="Image" class="img-responsive"></a>
                     <caption><?=$restaurant[$counter-1]['name'] ?></caption>
                    </div>
                    <?php   }  ?>
                  </div>
                  <!--/row-->
 ...
 <div class="col-md-12">
         <h2><a href="<?=base_url()?>index.php/locus/index_food_category/b" style="text-decoration:none;font-weight: 60px;">Beverages</a></h2>
         <div class="well">
          <div id="myCarousel3" class="carousel slide">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active">
                    ...
                    $t =  $beverages[$counter++]['thumbnail'];?>
                    <div class="col-sm-3"><a href="#x"><img src="<?=base_url($t)?>" alt="Image" class="img-responsive "></a>
                     <caption><?=$beverages[$counter-1]['name'] ?></caption>
                    </div>
                    <?php   }  ?>
                  </div>
                  <!--/row-->
...
<div class="col-md-12">
         <h2><a href="<?=base_url()?>index.php/locus/index_food_category/d" style="text-decoration:none;font-weight: 60px;">Desserts & Bakeries </a></h2>
         <div class="well">
          <div id="myCarousel4" class="carousel slide">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active">
                    ...
                    $t =  $dess[$counter++]['thumbnail'];?>
                    <div class="col-sm-3"><a href="#x"><img src="<?=base_url($t)?>" alt="Image" class="img-responsive"></a>
                     <caption><?=$dess[$counter-1]['name'] ?></caption>
                    </div>
                    <?php   }  ?>
                  </div>
                  <!--/row-->
...
$.post('<?=base_url()?>index.php/locus/check_login', postData, function(data){
  if(data=='fail'){
    ...
    window.location="<?=base_url()?>index.php/locus/index_food";
  }
});
});
